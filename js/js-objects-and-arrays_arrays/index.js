...
exampleArray.push(42, "the meaning of life");
...
nestedArray.push(["emptyArray", "inside nestedArray"]);
...
console.log("Array: ", numbers, "first number in Array = ", firstNumber);
...
fruitsWithPop.pop(fruitsWithPop.length - 1);
...
shiftedFruits.shift(shiftedFruits[0]);
