...
[x] First and last name are required and are allowed to have at least 4 and up to 30 characters.
[x] The user needs to be at least 14 years old.
[x] We need a correct email adress (i.e. including an `@` symbol) for contacting the user.
[x] It's necessary that the user has read the terms of service and agrees to them.
