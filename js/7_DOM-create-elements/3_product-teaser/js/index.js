...
let productPost = document.createElement("article");
productPost.classList.add("product");
let productCard = `<div class="product__body">
...
productPost.innerHTML = productCard;

document.body.append(productPost);
